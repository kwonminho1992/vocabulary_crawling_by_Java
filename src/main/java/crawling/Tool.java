...
/**
 * This class provides useful methods to organize crawling file of each language.
 * You can apply methods of Frame class to class files of each languae
 * @author Kwon Minho
 *
 */
public class Tool {
	...
	public ChromeDriver getDriver () throws InterruptedException {
		...
		options.addArguments("--headless", "--disable-gpu", "--blink-setting=imagesEnable=false", 
				...
				"--disable-default-apps", "--disable-popup-blcking", "--blink-setting");
