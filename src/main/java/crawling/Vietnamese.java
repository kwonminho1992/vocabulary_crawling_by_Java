  ...
  public String addLink(String word) {
    String link =
        "<a href=\"https://www.google.co.kr/search?q=" + word + "&tbm=isch\">image link</a><br><br>"
            + "<a href=\"http://tratu.coviet.vn/hoc-tieng-anh/tu-dien/lac-viet/V-V/" + word
            + ".html\">" + "http://tratu.coviet.vn/hoc-tieng-anh/tu-dien/lac-viet/V-V/" + word
            + ".html" + "</a><br><br><a " + "href=\"http://tratu.soha.vn/dict/vn_vn/" + word + "\">"
